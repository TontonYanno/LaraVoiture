...
<!-- owner inscription -->
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Forms de Propriétaire</h5>
              @if (session('success'))
            ...
            <form action=" {{route('ownerregister')}}"  method='post' enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                @error('email')
                    <div class="alert alert-danger">{{ $message="Votre email est incorrect" }}</div>
                @enderror
              </div>
...
<!-- end owner inscription -->

<!-- Recent owner -->
        <div class="col d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body p-4">
              <h5 class="card-title fw-semibold mb-4">Recent Owners</h5>
              @if (session('delete'))
                <div class="alert alert-success" role="alert">
                {{ session('delete') }}
              </div>
                ...
                <table class="table text-nowrap mb-0 align-middle">
                  ...
                  <tbody>
                    @foreach ( $list as $product)
                      <tr>
                        <td class="borduserser-bottom-0"><h6 class="fw-semibold mb-0"> {{$product->id}} </h6></td>
